...
class UpdatePostResource(Resource):
	...
	Takes parameters:
	    ...
	    topics_add: list (comma-separated values in string) (this value will append topics to the current list of topics)
	...
	def put(self):
		...
		if new_topics_string != None:
			new_topics = new_topics_string.split(",")
			post_to_update.topics = json.dumps(new_topics)
